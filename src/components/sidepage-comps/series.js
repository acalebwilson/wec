...
import { loginAction, logoutAction, headerAction, openSidePageAction, closeSidePageAction, sidePageAction, audioListAction } from '../../redux/actions'
        ...
        return (
            <div className="side-page-content">
                <div className="side-page-section">
                    <AddSeriesForm getSeries={this.getSeries} setFormActive={this.props.setFormActive} setFormInactive={this.props.setFormInactive}/>
                </div>
    ...
    handleChange(event) {
        switch (event.target.id) {
            ...
            case "series-description":
                this.setState({description: event.target.value, descriptionValid: true})
                break
            default:
                break
        }
        ...
        return (
            <form className="audio-form">
                <FormSection valid={this.state.titleValid}>
                    ...
                    <input type="text" id="series-title" onChange={this.handleChange} value={this.state.title}/>
                </FormSection>
                <FormSection valid={this.state.descriptionValid}>
                    <label htmlFor="series-description">Description:</label>
                    <textarea id="series-description" onChange={this.handleChange} value={this.state.description}/>
                </FormSection>
                <button className="upload" onClick={(e) => {
                    e.preventDefault()
                    this.handleSubmit()
                }}>Add</button>
            </form>
    ...
    render() {
        ...
        if (this.props.series) {
            ...
            series = seriesList.map(item => {
                return <SeriesLine title={item.title} description={item.description} key={item.title}/>
            })
        }
        return (
            <React.Fragment>
